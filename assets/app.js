...
/* Ключ Яндекс.Карт. Пусто — карта не грузится, показывается список городов.
   Получить: https://developer.tech.yandex.ru → JavaScript API и HTTP Геокодер */
var YMAPS_KEY='';
/* Координаты населённых пунктов для меток на карте (по адресам объектов) */
var GEO_COORDS={
  'Геленджик':[44.5622,38.0848],'Краснодар':[45.0355,38.9753],'Новороссийск':[44.7235,37.7686],
  'Славянск-на-Кубани':[45.2580,38.1280],'г. Славянск':[45.2580,38.1280],'ст. Тбилисская':[45.3667,40.1833],
  'ст. Павловская':[46.1333,39.7833],'СНТ Маяк':[44.8950,37.3160],'СНТ Нептун':[44.6000,38.0500],
  'СНТ Заря':[45.0700,39.0300],'ул. Поварская':[45.0355,38.9753]
};
...
function injectWidgets(){
  ...
  // Sticky CTA (моб.)
  '<div class="mcta"><a href="tel:'+PHONE_TEL+'" class="mcta-call" aria-label="Позвонить" onclick="try{ym(109746794,\'reachGoal\',\'mcta_call\')}catch(_){}">📞</a>',
    '<a href="'+WA_LINK+'" target="_blank" rel="noopener" class="mcta-wa" aria-label="WhatsApp" onclick="try{ym(109746794,\'reachGoal\',\'mcta_wa\')}catch(_){}"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.05 4.91A9.82 9.82 0 0 0 12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38a9.86 9.86 0 0 0 4.79 1.22h.01c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.91-7.02zm-7.01 15.24c-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.2 8.2 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.25-8.24 2.2 0 4.27.86 5.82 2.42a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.24-8.25 8.24zm4.52-6.16c-.25-.12-1.47-.72-1.69-.81-.23-.08-.39-.12-.56.13-.17.25-.64.81-.79.97-.14.17-.29.19-.54.06-.25-.12-1.05-.39-1.99-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.01-.38.11-.51.11-.11.25-.29.37-.43.12-.14.17-.25.25-.41.08-.17.04-.31-.02-.43-.06-.12-.56-1.34-.76-1.84-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.43.06-.66.31-.23.25-.86.85-.86 2.07 0 1.22.89 2.4 1.01 2.56.12.17 1.75 2.67 4.23 3.74.59.26 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.68-1.18.21-.58.21-1.07.14-1.18-.06-.11-.22-.17-.47-.29z"/></svg></a>',
    '<a href="'+TG_LINK+'" target="_blank" rel="noopener" class="mcta-tg" aria-label="Telegram" onclick="try{ym(109746794,\'reachGoal\',\'msg_tg\')}catch(_){}"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.94 4.66 18.6 20.4c-.25 1.1-.9 1.38-1.83.86l-5.05-3.72-2.44 2.35c-.27.27-.5.5-1.02.5l.36-5.14L16.98 7.4c.4-.36-.09-.56-.63-.2L6.78 13.1l-4.99-1.56c-1.08-.34-1.1-1.08.23-1.6l19.5-7.52c.9-.34 1.69.2 1.42 2.24z"/></svg></a>',
    '<a href="#lead" class="mcta-form" onclick="try{ym(109746794,\'reachGoal\',\'mcta_form\')}catch(_){}">Смета за 15 мин</a></div>',
  // Плавающие мессенджеры (десктоп + моб.)
  '<div class="msg-float">'+
    '<a href="'+WA_LINK+'" target="_blank" rel="noopener" class="msg-btn msg-wa" aria-label="Написать в WhatsApp" onclick="try{ym(109746794,\'reachGoal\',\'msg_wa\')}catch(_){}"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M19.05 4.91A9.82 9.82 0 0 0 12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38a9.86 9.86 0 0 0 4.79 1.22h.01c5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.91-7.02zM12.04 20.15c-1.48 0-2.93-.4-4.2-1.15l-.3-.18-3.12.82.83-3.04-.2-.31a8.2 8.2 0 0 1-1.26-4.38c0-4.54 3.7-8.24 8.25-8.24 2.2 0 4.27.86 5.82 2.42a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.24-8.25 8.24zm4.52-6.16c-.25-.12-1.47-.72-1.69-.81-.23-.08-.39-.12-.56.13-.17.25-.64.81-.79.97-.14.17-.29.19-.54.06-.25-.12-1.05-.39-1.99-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.01-.38.11-.51.11-.11.25-.29.37-.43.12-.14.17-.25.25-.41.08-.17.04-.31-.02-.43-.06-.12-.56-1.34-.76-1.84-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.43.06-.66.31-.23.25-.86.85-.86 2.07 0 1.22.89 2.4 1.01 2.56.12.17 1.75 2.67 4.23 3.74.59.26 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.68-1.18.21-.58.21-1.07.14-1.18-.06-.11-.22-.17-.47-.29z"/></svg></a>'+
    '<a href="'+TG_LINK+'" target="_blank" rel="noopener" class="msg-btn msg-tg" aria-label="Написать в Telegram" onclick="try{ym(109746794,\'reachGoal\',\'msg_tg\')}catch(_){}"><svg viewBox="0 0 24 24" fill="currentColor"><path d="M21.94 4.66 18.6 20.4c-.25 1.1-.9 1.38-1.83.86l-5.05-3.72-2.44 2.35c-.27.27-.5.5-1.02.5l.36-5.14L16.98 7.4c.4-.36-.09-.56-.63-.2L6.78 13.1l-4.99-1.56c-1.08-.34-1.1-1.08.23-1.6l19.5-7.52c.9-.34 1.69.2 1.42 2.24z"/></svg></a>'+
  '</div>',
  // Exit-intent
...
/* ============================================================
   14) ГЕОГРАФИЯ ОБЪЕКТОВ + КАРТА (если есть #objGeo)
   ============================================================ */
function initObjGeo(){
  ...
  var mapEl=$('#objMap');if(!mapEl)return;
  function fallback(){mapEl.style.display='none';list.classList.add('geo-list-full');var w=mapEl.parentNode;if(w)w.classList.add('geo-wrap-full');}
  if(!YMAPS_KEY){fallback();return;}
  var s=document.createElement('script');
  s.src='https://api-maps.yandex.ru/2.1/?apikey='+YMAPS_KEY+'&lang=ru_RU';
  s.onload=function(){if(!window.ymaps){fallback();return;}ymaps.ready(function(){
    var map=new ymaps.Map(mapEl,{center:[45.0,38.7],zoom:8,controls:['zoomControl']});
    try{map.behaviors.disable('scrollZoom');}catch(_){}
    OBJECTS.forEach(function(o){
      var c=GEO_COORDS[o.addr];if(!c)return;
      var pm=new ymaps.Placemark(c,{balloonContentHeader:o.addr,balloonContentBody:'Построенный нами дом',hintContent:o.addr},{preset:'islands#greenHomeIcon'});
      pm.events.add('click',function(){openGallery(o.photos,'Адрес: '+o.addr);});
...
function boot(){
  ...
  initSlider();renderProj('Все');renderObjects();initGalleries();initCalc();initFaq();initQuiz();initMortgage();initObjGeo();
}
